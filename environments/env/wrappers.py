...
# green_screen_calls = 0
# total_time = 0

# def do_green_screen(obs, bg):
#     """
#     Optimized version with detailed logging
#     """
#     global green_screen_calls, total_time
#     start_time = time.time()
    
#     green_screen_calls += 1
#     print(f"[Green Screen #{green_screen_calls}] Starting green screen processing...")
#     print(f"  Input - obs shape: {obs.shape}, bg shape: {bg.shape}")
...
#     print("  Creating green screen mask...")
#     green_mask = (g > r + 30) & (g > b + 30) & (g > 100)
#     green_pixels = green_mask.sum()
#     print(f"  Found {green_pixels} green pixels out of {green_mask.size} total")
    
#     # Apply mask efficiently
#     print("  Applying mask...")
#     result = obs.copy()
#     result[:, green_mask] = bg[:, green_mask]
    
#     end_time = time.time()
#     call_time = end_time - start_time
#     total_time += call_time
    
#     avg_time = total_time / green_screen_calls
#     print(f"  Completed in {call_time:.4f}s (avg: {avg_time:.4f}s)")
#     print(f"  Total calls: {green_screen_calls}, Total time: {total_time:.4f}s")
#     print("  ----------------------------------------")
...
class VideoWrapper(gym.Wrapper):
	...
	def _get_video_paths(self):
		video_dir = os.path.join('./environments/env/data', self._mode)
